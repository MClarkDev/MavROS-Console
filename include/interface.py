...
class Interface:
    ...
    def __init__(self):
        ...
        health.addWidget(QLabel("Volts"), 0, 0, 1, 1)
        health.addWidget(self.uiBatV, 0, 1, 1, 1)
        health.addWidget(QLabel("Amps"), 1, 0, 1, 1)
        health.addWidget(self.uiBatA, 1, 1, 1, 1)
        ...
        gps.addWidget(QLabel("Location"), 0, 0, 1, 2)
        gps.addWidget(self.uiGpsLat, 0, 2, 1, 1)
        gps.addWidget(self.uiGpsLon, 0, 3, 1, 1)
        gps.addWidget(QLabel("Altitude"), 1, 0, 1, 2)
        gps.addWidget(self.uiGpsAlt, 1, 2, 1, 2)
        gps.addWidget(QLabel("Satellites"))
        gps.addWidget(self.uiGpsCnt, 2, 1, 1, 1)
        gps.addWidget(QLabel("Heading"), 3, 0, 1, 1)
        gps.addWidget(self.uiGpsHdg, 3, 1, 1, 1)
    ...
    def updateUI(self):
        ...
        self.uiBatA.setText("{:.2f}A".format(self.state.pwrA))
        self.uiGpsLat.setText("{:.4f}".format(self.state.gpsLat))
        self.uiGpsLon.setText("{:.4f}".format(self.state.gpsLon))
