...
class Interface:
    ...
    def __init__(self):
        ...
        imu.addWidget(self.uiImuRx, 2, 1, 1, 2)
        imu.addWidget(self.uiImuAx, 2, 3, 1, 2)
        imu.addWidget(QLabel("Y:"), 3, 0, 1, 1)
        imu.addWidget(self.uiImuRy, 3, 1, 1, 2)
        imu.addWidget(self.uiImuAy, 3, 3, 1, 2)
        imu.addWidget(QLabel("Z:"), 4, 0, 1, 1)
        imu.addWidget(self.uiImuRz, 4, 1, 1, 2)
        imu.addWidget(self.uiImuAz, 4, 3, 1, 2)
    ...
    def updateUI(self):
        ...
        self.uiImuRx.setText("{:.3f}".format(self.state.imuRx))
        self.uiImuRy.setText("{:.3f}".format(self.state.imuRy))
        self.uiImuRz.setText("{:.3f}".format(self.state.imuRz))
        self.uiImuAx.setText("{:.3f}".format(self.state.imuAx))
        self.uiImuAy.setText("{:.3f}".format(self.state.imuAy))
        self.uiImuAz.setText("{:.3f}".format(self.state.imuAz))
